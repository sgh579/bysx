...
QT_MOC_LITERAL(1, 7, 24), // "read_ready_decode_signal"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 10), // "m_readData"
QT_MOC_LITERAL(4, 44, 15), // "handleReadyRead"
QT_MOC_LITERAL(5, 60, 13), // "handleTimeout"
QT_MOC_LITERAL(6, 74, 11), // "handleError"
QT_MOC_LITERAL(7, 86, 28), // "QSerialPort::SerialPortError"
QT_MOC_LITERAL(8, 115, 5) // "error"

    },
    "reader\0read_ready_decode_signal\0\0"
    "m_readData\0handleReadyRead\0handleTimeout\0"
...
void reader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->read_ready_decode_signal((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        ...
        {
            typedef void (reader::*_t)(const QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&reader::read_ready_decode_signal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void reader::read_ready_decode_signal(const QByteArray _t1)
{
